        ...
        <div class="row s_product_inner">
            <div class="col-lg-6">
                ...
                <div class="owl-carousel owl-theme s_Product_carousel">
                    <div class="single-prd-item">
                        <img class="img-fluid" src="<?= base_url('/assets/img/produk/' . $barang['gambar']); ?>" alt="">
                    </div>
                </div>
            </div>
            <div class="col-lg-5 offset-lg-1">
                <div class="s_product_text">
                    ...
                    ?>
                    <h3><?= $barang['judul']; ?></h3>
                    <h2><?= rupiah($barang['harga']); ?></h2>
                    <ul class="list">
                        <li><span>Kategori</span> : <?= $barang['kategori']; ?> </a></li>
                    ...
                    <div class="product_count">
                        ...
                        <a class=" button primary-btn" href="/pages/keranjang/<?= $barang['slug']; ?>
                    ...
                    <div class="col-lg-6">
                        <div class="review_box">
                            ...
                            <form action="#/" class="form-contact form-review mt-3">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control " name="textarea" id="textarea" cols="30" rows="5" placeholder="Enter Message"></textarea>
                                </div>
                                <div class="form-group text-center text-md-right mt-3">
                                    <button type="submit" class="button button--active button-review">Kirim</button>
                                </div>
                            </form>
                        </div>
                    </div>
